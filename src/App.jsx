...
function App() {
  const myGithubRepo = "https://github.com/anayaricardo/Curso-React.js/tree/master"; // ¡CAMBIA ESTO POR TU REPOSITORIO REAL!
  ...
  return (
    <>
      ...
      <Counter /><br/><hr/><br/>
      <UseStateInfo /><br/>
      <MiFormulario /><br/><hr/><br/>
      <UIChangesInfo /><br/>
      <MiBoton /><br/><br/><hr/><br/>
      <TemporaryStateInfo /><br/>
      <Temporizador /><br/><hr/><br/>
      <CollectionsInfo /><br/>
      <ListaDeTareas /><br/><hr/><br/>
      <UseStateSummary />
      <Footer githubRepoLink={myGithubRepo} linkedinProfileLink={myLinkedinProfile} />
      </>
  )
}
